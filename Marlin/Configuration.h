...
#define STRING_CONFIG_H_AUTHOR "(Gruvin, Gruvinator SKR PRO)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // firmware implemented USB
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 1 // Marked "TFT" on SKR Pro board.
...
#define CUSTOM_MACHINE_NAME "Gruvinator V2"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.5, 80.5, 400, 440 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 28, 60 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 200, 200, 28, 80 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3600, 3600, 200, 10000 }
...
#define DEFAULT_EJERK    2.5  // Highly affects Linear Advance
 ...
 *
 */
#define Z_MIN_PROBE_PIN Z_MAX_PIN // EO endstop // Pin 32 is the RAMPS default
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_Z_RAISE_WHEN_OFF_MESH 4.0 // When the nozzle is off the mesh, this value is used
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 1.5  // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
