...
#define STRING_CONFIG_H_AUTHOR "(Gruvin, RC8 Base)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Wishful 1"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.5, 80.5, 400.0, 97 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 60, 80 }
...
#define Z_PROBE_OFFSET_RANGE_MAX -0.05
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_1_Y (Y_MAX_POS-40)
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X0 Y0 Z10 F8000" // These commands (use \n to separate) will be executed in the end of G29 routine.
...
#define HOMING_FEEDRATE_Z  (400*1.314777) // @#$! resonance. machine needs dampening.
