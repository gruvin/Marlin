...
#define STRING_CONFIG_H_AUTHOR "(Gruvin, Hypercube SKR)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 0 // Marked "TFT" on SKR 1.3 board
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 // firmware implemented USB
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3D v6 PT-100 with silicone sock
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 48.5
  #define DEFAULT_bedKi 3.3
  #define DEFAULT_bedKd 460
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.25, 80.25, 800, 96 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.5, 160.5, 800, 96 }
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 200, 200, 20, 80 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3600, 3600, 200, 8000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 4000, 4000, 300, 10000 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 0.6, 40 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *
 */
#define Z_MIN_PROBE_PIN P1_24 // Z_MAX_PIN
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, -4, 0 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE          120  // (mm/s) Feedrate for XY Moves for the G26 Mesh Validation Tool.
  #endif
 ...
 *   BJR: STM32 ** REQUIRES LCD PANEL SDCARD ** for EEPROM.DAT file
 */
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE  400   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
...
//#define FAST_PWM_FAN // stuffs up SERVO (BL-TOUCH) timing on SKR 1.3
