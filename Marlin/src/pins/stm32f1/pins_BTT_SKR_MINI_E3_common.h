 ...
 *   (BTN_E1) A  | 3 4 | B (BTN_E2)         (BTN_EN1) PB15 | 3 4 | PB8 (BTN_EN2)
 *          BEEP | 5 6   ENT (BTN_ENC)                PB9  | 5 6   RX1
 *  (SKR_RX1) TX | 7 8 | RX (SKR_TX1)                RESET | 7 8 | TX1
 *            NC | 9 10| NC                  (BEEPER) PA15 | 9 10| PB5  (BTN_ENC)
 *                -----                                     -----
 *                EXP1                                      EXP1
 *  NOTE: Creality's DWIN code stands apart from other DWIN implementations
 *        and uses SERIAL_PORT_2 (channel 1), exclusively. LCD_SERIAL_PORT is **ignored**.
 */
#if ENABLED(DWIN_CREALITY_LCD)

//#error "DWIN_CREALITY_LCD requires wiring modifications. See 'pins_BTT_SKR_MINI_E3_common.h:133' for details. Comment out this line to continue."
...
/**
 *        MKS H43 displ    ay                         SKR Mini E3 V2.0
 *                _____                                     _____
 *            5V | 1 2 | 5V                             5V | 1 2 | GND
 *           GND ~ 3 4 | GND                (BTN_EN1) PB15 | 3 4 | PB8 (BTN_E2)
 *            NC ~ 5 6 | RX                   (BEEPER) PB9 | 5 6   RX1
 *            NC | 7 8 | TX                          RESET | 7 8 | TX1
 *                -----                     (BTN_ENC) PA15 | 9 10| PB5
 *                AUX-1                                     -----
 *                                                           EXP1
 */
#if ENABLED(DGUS_LCD_UI_MKS)
  #error "DGUS_LCD_UI_MKS requires wiring modifications. See 'pins_BTT_SKR_MINI_E3_common.h:159' for details. Comment out this line to continue."
#endif
